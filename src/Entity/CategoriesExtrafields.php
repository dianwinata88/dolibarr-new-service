...
#[ORM\Entity]
#[ORM\Table(name: 'llx_categories_extrafields', options: ['charset' => 'utf8mb4', 'collate' => 'utf8mb4_unicode_ci'])]
#[ORM\UniqueConstraint(name: 'uk_categories_extrafields', columns: ['fk_object'])]
