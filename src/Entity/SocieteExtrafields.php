...
#[ORM\Entity]
#[ORM\Table(name: 'llx_societe_extrafields', options: ['charset' => 'utf8mb4', 'collate' => 'utf8mb4_unicode_ci'])]
#[ORM\UniqueConstraint(name: 'uk_societe_extrafields', columns: ['fk_object'])]
class SocieteExtrafields
{
    #[ORM\Id]
